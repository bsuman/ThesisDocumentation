\chapter{Design Analysis} \label{DA}
...
\begin{lstlisting}[label={lst:SCF},caption={Slave Configuration file Node 2 }]
{
   "ComponentConfiguration": "//pc2215/SharedFolder/layered_halftoner_CMYK_PrintJob.json",
   "PrinterSpecs": "//pc2215/SharedFolder/printer_specs_layer_profile_CMYK.json",
   "CommunicatorType": "NetworkCommMPI",
...
\begin{figure}[ht!]
\centering
\includegraphics[scale=0.6]{SequenceDiagram1.pdf}
...
\begin{figure}[ht!]
\centering
\includegraphics[scale=0.6]{Approximation_graph.pdf}
...
\begin{figure}[ht!]
\centering
\includegraphics[scale=0.8]{SlaveReporterActivityDiagram.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[scale=0.6]{ProducerConsumerProblem.pdf}
...
\begin{figure}[ht!]
\centering
\includegraphics[scale=0.75]{MasterMergerComponent.pdf}
...
\subsection{Printing Software Components and Printer Specification}
...
\begin{figure}[!t]
\centering
\includegraphics[scale=0.9]{ProtoII_SequenceDiagram.pdf}
...
The disadvantages of the prototype II are: 
\begin{itemize}
...
\begin{figure}[!t]
\centering
\includegraphics[scale=0.65]{SerDeser.pdf}
...
\begin{figure}[!t]
\centering
\includegraphics[scale=0.45]{Communication_Abstraction.pdf}
