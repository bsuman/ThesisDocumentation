...
\begin{figure}[ht!]
\centering
\includegraphics[scale=0.6]{Approximation_graph.png}
...
\begin{figure}[ht!]
\centering
\includegraphics[scale=0.75]{MasterMergerComponent.png}
...
\begin{figure}[!t]
\centering
\includegraphics[scale=0.9]{ProtoII_SequenceDiagram.PNG}
...
\begin{figure}[!t]
\centering
\includegraphics[scale=0.45]{Communication_Abstraction.PNG}
