...
\begin{figure}[ht!]
\centering
\includegraphics[scale=0.7]{3DPProcess.pdf}
...
\begin{figure}[ht!]
\centering
\includegraphics[scale=0.6]{slicing.pdf}
\caption{Slicing}
\label{fig:slic}
\end{figure}
...
\begin{figure}[ht!]
\centering
\includegraphics[scale=0.6]{BeforeFinishing.pdf}
...
\begin{figure}[ht!]
\centering
\includegraphics[scale=0.6]{AfterFinishing.pdf}
...
\begin{figure}[ht!]
\centering
\includegraphics[scale=0.6]{DistributedSystem.pdf}
