...
set terminator=6
:loop
mpiexec -hosts 6 PC2215 PC2408 PC2339 PC2286 PC2154 PC2179 -wdir \\pc2215\SharedFolder\MRepo\p3d_build\windows\bin\Release\ Cuttlefish.exe \\pc2215\SharedFolder\MasterThesis\Documentation\ThesisDocumentation\Results\ScenarioII-DifferentModels\PrototII\Run4\main_conf.json
