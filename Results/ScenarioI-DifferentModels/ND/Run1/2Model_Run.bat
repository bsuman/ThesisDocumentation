...
set Destpath= D:\MasterThesis\Documentation\ThesisDocumentation\Results\ScenarioI-DifferentModels\ND\Run1\

set var=1
set terminator=6
:loop
D:\MRepo\p3d_build\windows\bin\Release\Cuttlefish.exe D:\MasterThesis\Documentation\ThesisDocumentation\Results\ScenarioI-DifferentModels\ND\Run1\main_conf.json -i
