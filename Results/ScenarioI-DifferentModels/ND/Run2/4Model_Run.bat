...
set Destpath= D:\MasterThesis\Documentation\ThesisDocumentation\Results\ScenarioI-DifferentModels\ND\Run2\

set var=2
set terminator=6
:loop
D:\MRepo\p3d_build\windows\bin\Release\Cuttlefish.exe D:\MasterThesis\Documentation\ThesisDocumentation\Results\ScenarioI-DifferentModels\ND\Run2\main_conf.json -i
