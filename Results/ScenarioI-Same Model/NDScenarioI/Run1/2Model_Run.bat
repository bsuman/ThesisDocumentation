...
set Destpath= D:\MasterThesis\Documentation\ThesisDocumentation\Results\NDScenarioI\Run1\

set var=5
set terminator=6
:loop
D:\MRepo\p3d_build\windows\bin\Release\Cuttlefish.exe D:\MasterThesis\Documentation\ThesisDocumentation\Results\NDScenarioI\Run1\main_conf.json -i
