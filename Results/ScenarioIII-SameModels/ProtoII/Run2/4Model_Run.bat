...
set terminator=6
:loop
mpiexec -hosts 5 PC2215 PC2408 PC2155 PC2286 PC2179 -wdir \\pc2215\SharedFolder\MRepo\p3d_build\windows\bin\Release\ Cuttlefish.exe \\pc2215\SharedFolder\MasterThesis\Documentation\ThesisDocumentation\Results\ScenarioIII-SameModels\ProtoII\Run2\main_conf.json
