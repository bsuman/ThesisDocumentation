...
set Destpath= D:\MasterThesis\Documentation\ThesisDocumentation\Results\ScenarioII-SameModels\Proto-II\Run3\

set var=2
set terminator=6
:loop
mpiexec -hosts 5 PC2215 PC2408 PC2339 PC2286 PC2154 -wdir \\pc2215\SharedFolder\MRepo\p3d_build\windows\bin\Release\ Cuttlefish.exe \\pc2215\SharedFolder\MasterThesis\Documentation\ThesisDocumentation\Results\ScenarioII-SameModels\Proto-II\Run3\main_conf.json
